...
fun ImportDialog(
    ...
    pendingImportDisplayName: String? = null,
    ...
    ImportDialogStateless(
        ...
        pendingImportDisplayName = pendingImportDisplayName,
        modifier = modifier
    )
}
    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                // Pending file, when one was handed in from outside (e.g. via ACTION_VIEW).
                // The format below is still always picked by the user, never auto-detected.
                if (pendingImportDisplayName != null) {
                    Text(
                        text = stringResource(
                            R.string.main_activity_import_pending_file,
