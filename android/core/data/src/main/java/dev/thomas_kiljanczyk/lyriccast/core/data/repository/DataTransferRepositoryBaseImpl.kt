 ...
 * Last modified 9/7/25, 2:28 PM
 */

package dev.thomas_kiljanczyk.lyriccast.core.data.repository

import android.util.Log
import dev.thomas_kiljanczyk.lyriccast.core.data.R
import dev.thomas_kiljanczyk.lyriccast.core.data.repository.DataTransferMapper.toDto
import dev.thomas_kiljanczyk.lyriccast.core.data.repository.DataTransferMapper.toModel
...
abstract class DataTransferRepositoryBaseImpl : DataTransferRepository {
    ...
    private suspend fun executeCategoryImport(
        ...
        val categories = categoryDtos.map { it.toModel() }.toMutableList()
    ...
    private suspend fun executeSongImport(
        ...
        val songs: MutableList<Song> = songDtos
            .map { dto ->
                ...
                val song = dto.toModel(categoryMap[dto.category])
                song.lyrics = lyricsSections
                song.presentation = dto.presentation
    ...
    private suspend fun executeSetlistImport(
        ...
        setlists.forEach { setlist ->
            ...
            setlist.presentation = presentation
        }
